...
public class DTO_INSUR {
	...
	public DTO_INSUR(int pR_ID, Date tREAT_DATE, String pATNT_NAME, String cID, String dOC, boolean iNSUR,
			int iNSUR_CHARGE, int hANDI_CHARGE, int sUP, int pATNT_CHARGE, int tOTAL_CHARGE) {
		super();
		PR_ID = pR_ID;
	...
	public DTO_INSUR(int iN_ID, int pR_ID, Date tREAT_DATE, String pATNT_NAME, String cID, String dOC, boolean iNSUR,
			int iNSUR_CHARGE, int hANDI_CHARGE, int sUP, int pATNT_CHARGE, int tOTAL_CHARGE) {
		super();
		IN_ID = iN_ID;
		PR_ID = pR_ID;
