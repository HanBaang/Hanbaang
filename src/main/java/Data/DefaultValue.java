...
public class DefaultValue {
	...
	public static final String SQL_SELECT_ACCOUNT_BY_ID = "Select AC_ID,ID,PW,HOSPI_NAME,ORG_NUM,COMP_NUM,PHONE,MAIL,ADDR,ADDR_DETAIL,REG_DATE,MOD_DATE From ACCOUNT Where ID=?;";
	public static final String SQL_SELECT_ACCOUNT_BY_ID_AND_PW = "Select AC_ID,ID,PW,HOSPI_NAME,ORG_NUM,COMP_NUM,PHONE,MAIL,ADDR,ADDR_DETAIL,REG_DATE,MOD_DATE From ACCOUNT Where ID=? AND PW=password(?);";
	...
	// RECEP TABLE
	public static final String SQL_INSERT_RECEP = "Insert Into RECEP(PA_ID,SA_ID,PATNT_NAME,RECEP_DATE,STATE,MEMO,MDOC,STAFF_NAME) Values (?,?,?,?,?,?,?,?);";
	public static final String SQL_SELECT_RECEP_BY_PK = "Select R_ID,PA_ID,SA_ID,PATNT_NAME,RECEP_DATE,STATE,MEMO,MDOC,STAFF_NAME From RECEP Where R_ID=?;";
	public static final String SQL_SELECT_RECEP = "Select R_ID,PA_ID,SA_ID,PATNT_NAME,RECEP_DATE,STATE,MEMO,MDOC,STAFF_NAME From RECEP;";
	public static final String SQL_UPDATE_RECEP_BY_PK = "Update RECEP Set PA_ID=?, SA_ID=?, PATNT_NAME=?, RECEP_DATE=?, STATE=?, MEMO=?, MDOC=?, STAFF_NAME=? Where R_ID=?;";
	public static final String SQL_DELETE_RECEP_BY_PK = "Delete From RECEP Where R_ID=?;";
	
	// TREAT TABLE
	public static final String SQL_INSERT_TREAT = "Insert Into TREAT(R_ID,MEMO) Values (?,?);";
	public static final String SQL_SELECT_TREAT_BY_PK = "Select TR_ID,R_ID,MEMO From TREAT Where TR_ID=?;";
	public static final String SQL_SELECT_TREAT = "Select TR_ID,R_ID,MEMO From TREAT;";
	public static final String SQL_UPDATE_TREAT_BY_PK = "Update TREAT Set R_ID=?, MEMO=? Where TR_ID=?;";
	public static final String SQL_DELETE_TREAT_BY_PK = "Delete From TREAT Where TR_ID=?;";
	
	// DRUG TABLE
	public static final String SQL_INSERT_DRUG = "Insert Into DRUG(PR_ID,DRUG_CODE,DRUG_COMP_NAME,DRUG_NAME,DRUG_WEIGHT,DRUG_MEMO,INSUR,TYPE,TYPE_ID) Values (?,?,?,?,?,?,?,?,?);";
	public static final String SQL_SELECT_DRUG_BY_PK = "Select DR_ID,PR_ID,DRUG_CODE,DRUG_COMP_NAME,DRUG_NAME,DRUG_WEIGHT,DRUG_MEMO,INSUR,TYPE,TYPE_ID From DRUG Where DR_ID=?;";
	public static final String SQL_SELECT_DRUG_BY_FK_PR = "Select DR_ID,PR_ID,DRUG_CODE,DRUG_COMP_NAME,DRUG_NAME,DRUG_WEIGHT,DRUG_MEMO,INSUR,TYPE,TYPE_ID From DRUG Where PR_ID=?;";
	public static final String SQL_SELECT_DRUG = "Select DR_ID,PR_ID,DRUG_CODE,DRUG_COMP_NAME,DRUG_NAME,DRUG_WEIGHT,DRUG_MEMO,INSUR,TYPE,TYPE_ID From DRUG;";
	public static final String SQL_UPDATE_DRUG_BY_PK = "Update DRUG Set PR_ID=?, DRUG_CODE=?, DRUG_COMP_NAME=?, DRUG_NAME=?, DRUG_WEIGHT=?, DRUG_MEMO=?, INSUR=?, TYPE=?, TYPE_ID=? Where DR_ID=?;";
	...
	// INSUR TABLE
	public static final String SQL_INSERT_INSUR = "Insert Into INSUR(PR_ID,TREAT_DATE,PATNT_NAME,CID,DOC,INSUR,INSUR_CHARGE,HANDI_CHARGE,SUP,PATNT_CHARGE,TOTAL_CHARGE) Values (?,?,?,?,?,?,?,?,?,?,?);";
	public static final String SQL_SELECT_INSUR_BY_PK = "Select IN_ID,PR_ID,TREAT_DATE,PATNT_NAME,CID,DOC,INSUR,INSUR_CHARGE,HANDI_CHARGE,SUP,PATNT_CHARGE,TOTAL_CHARGE From INSUR Where IN_ID=?;";
	public static final String SQL_SELECT_INSUR = "Select IN_ID,PR_ID,TREAT_DATE,PATNT_NAME,CID,DOC,INSUR,INSUR_CHARGE,HANDI_CHARGE,SUP,PATNT_CHARGE,TOTAL_CHARGE From INSUR;";
	public static final String SQL_UPDATE_INSUR_BY_PK = "Update INSUR Set PR_ID=?, TREAT_DATE=?, PATNT_NAME=?, CID=?, DOC=?, INSUR=?, INSUR_CHARGE=?, HANDI_CHARGE=?, SUP=?, PATNT_CHARGE=?, TOTAL_CHARGE=? Where IN_ID=?;";
	...
	//PHYSIC TABLE
	public static final String SQL_INSERT_PHYSIC = "Insert Into PHYSIC(CH_ID,TR_ID,PH_TYPE,NAME,PART_CODE,INSUR) Values (?,?,?,?,?,?);";
	public static final String SQL_SELECT_PHYSIC_BY_PK = "Select PH_ID,CH_ID,TR_ID,PH_TYPE,NAME,PART_CODE,INSUR From PHYSIC Where PH_ID=?;";
	public static final String SQL_SELECT_PHYSIC = "Select PH_ID,CH_ID,TR_ID,PH_TYPE,NAME,PART_CODE,INSUR From PHYSIC;";
	public static final String SQL_UPDATE_PHYSIC_BY_PK = "Update PHYSIC Set CH_ID=?, TR_ID=?, PH_TYPE=?, NAME=?, PART_CODE=?, INSUR=? Where PH_ID=?;";
	...
	//SYMP TABLE
	public static final String SQL_INSERT_SYMP = "Insert Into SYMP(TR_ID,SYMP_CODE,SYMP_NAME,INSUR) Values (?,?,?,?);";
	public static final String SQL_SELECT_SYMP_BY_PK = "Select SY_ID,TR_ID,SYMP_CODE,SYMP_NAME,INSUR From SYMP Where SY_ID=?;";
	public static final String SQL_SELECT_SYMP = "Select SY_ID,TR_ID,SYMP_CODE,SYMP_NAME,INSUR From SYMP;";
	public static final String SQL_UPDATE_SYMP_BY_PK = "Update SYMP Set TR_ID=?, SYMP_CODE=?, SYMP_NAME=?, INSUR=? Where SY_ID=?;";
	public static final String SQL_DELETE_SYMP_BY_PK = "Delete From SYMP Where SY_ID=?;";
